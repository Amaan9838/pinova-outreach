...
const FOUNDRY_ENDPOINT = 'https://amaan-mcf7ntpz-eastus2.services.ai.azure.com/anthropic/';

const FOUNDRY_DEPLOYMENT = 'claude-haiku-4-5';

const FOUNDRY_API_VERSION = '2023-06-01';
...
export async function generateReplyResponse(context) {
  ...
  if (intent === 'positive') {
    intentGuidance = 'Lead showed genuine interest. Respond warmly, say the preview or next deliverable can be sent within the next hour if that fits the campaign offer, and propose one clear next step.';
