...
export class CampaignExecutor {
  ...
  async sendSequenceEmail(campaignProspect) {
    ...
    const personalizedTemplate = step.template
      .replace(/\{\{firstName\}\}/g, campaignProspect.prospectId.firstName || 'there')
      .replace(/\{\{lastName\}\}/g, campaignProspect.prospectId.lastName || '')
      .replace(/\{\{email\}\}/g, campaignProspect.prospectId.email || '')
      .replace(/\{\{company\}\}/g, campaignProspect.prospectId.company || '');
